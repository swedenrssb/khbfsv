...
public void fill_up_all_the_fields_and_then_tap_on_register_button() {
 ...
 System.out.println("User Enter Last Name ");
 driver.findElement(By.xpath("//*[@id=\"registration\"]/fieldset/div[3]/div[1]/input")).sendKeys("venkatesh@in");  
 
 System.out.println("User Enter ID ");
 driver.findElement(By.id("username")).sendKeys("vrentala");
...
public void fill_up_the_fields_send_to_subject_message() {
	...
	//driver.findElement(By.xpath("//*[@id=\"compose_message\"]/fieldset/div[1]/div[1]/span/span[1]/span/ul/li/input")).sendKeys("Mhatre@sne.in");
...
public void Enter_firstName() {
	...
	driver.findElement(By.xpath("//*[@id='profile']/fieldset/div[1]/div[1]/input")).sendKeys("Meow111");
}

@Then("Enter lastname")
public void Enter_lastname() {
	driver.findElement(By.xpath("//*[@id='profile']/fieldset/div[2]/div[1]/input")).clear();
	driver.findElement(By.xpath("//*[@id='profile']/fieldset/div[2]/div[1]/input")).sendKeys("TTT");
}
